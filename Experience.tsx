        ...
        >
          ...
          <div className="space-y-4 text-left">
            <motion.div
              ...
              "
            >
              <h3 className="text-sm font-semibold text-[#0A1A3E]">
              ...
              <ul className="mt-3 space-y-1.5 text-sm text-slate-700 leading-6 list-disc list-inside">
                <li>
            ...
            >
              ...
              <ul className="mt-3 space-y-1.5 text-sm text-slate-700 leading-6 list-disc list-inside">
                ...
                <li>Developed cloud-native ingestion pipelines.</li>
                <li>
