          ...
          <div className="space-y-6 text-left">
            ...
            >
              ...
              <ul className="mt-5 space-y-3 text-gray-700 text-lg list-disc list-inside">
                <li>
                  Designed & operated large-scale batch + streaming pipelines
                  processing{" "}
                  <span className="font-semibold text-[#0A1A3E]">1B+</span>{" "}
                  records using PySpark, Databricks & Delta Lake.
                </li>
                <li>
                ...
                <li>
                  Implemented CI/CD with Docker, GitHub Actions & Terraform.
                </li>
                <li>
                  Modernized DWH on Snowflake & BigQuery.
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="mt-5 space-y-3 text-gray-700 text-lg list-disc list-inside">
                ...
                <li>
                  Optimized BigQuery with partitioning & clustering (60% faster).
                </li>
                <li>
                  Developed cloud-native ingestion pipelines.
                </li>
                <li>
                  Collaborated on data modeling & warehouse design.
                </li>
              </ul>
            </motion.div>
